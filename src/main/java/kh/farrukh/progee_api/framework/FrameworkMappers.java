...
public class FrameworkMappers {
    ...
    public static Framework toFramework(
        ...
        framework.setImage(imageRepository.findById(frameworkRequestDTO.getImageId())
                .orElseThrow(() -> new ResourceNotFoundException("Image", "id", frameworkRequestDTO.getImageId())));
        framework.setLanguage(languageRepository.findById(frameworkRequestDTO.getLanguageId())
                .orElseThrow(() -> new ResourceNotFoundException("Language", "id", frameworkRequestDTO.getLanguageId())));
        return framework;
    }
}
