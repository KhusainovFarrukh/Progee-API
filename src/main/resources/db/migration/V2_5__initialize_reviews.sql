...
VALUES (1, NOW(),
        ...
        2, 1),
       (2, NOW(),
        'I have been working in Java technologies for more than 10 years',
        2, 1),
       (3, NOW(),
        'it is the “Beige Volvo Estate Wagon” of programming languages…slow, boring, reliable, safe…yawn',
        -1, 1),
       (2, NOW(),
        'People say it is like Java, but much better',
        1, 2),
       (2, NOW(),
